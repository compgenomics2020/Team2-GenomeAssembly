...
def spades_runner(fastq_file_forward, fastq_file_reverse, input_directory_path, output_directory_path):
	#Create file paths.
	...
	try:
		...
		print("SPAdes could not finish the assembly. Please chek the files.")
		return False
